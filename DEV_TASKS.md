...
- [ ] `Tests/DomainTests/SearchRepositoriesUseCaseTests.swift` 작성

## Phase 2 – Data 레이어 (테스트 포함)
...
## Phase 3 – Presentation 레이어 (테스트 포함)
...
- [ ] `Sources/Presentation/Search/SearchView.swift` 구현
- [ ] (필요 시) ResultListView / RepositoryWebView 구현
- [ ] `Tests/PresentationTests/SearchViewModelTests.swift` 작성
